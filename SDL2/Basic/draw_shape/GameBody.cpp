...
GameBody::GameBody(const string title,int width,int height,Uint32 flag,int delaytime):height(height),width(width),error(false),gamequit(false),delaytime(delaytime){
